"""Edit Monster Card v1
Allows the user to edit an existing monster card details
"""
import easygui
...
while True:
    ...
    selected_monster = monster_catalogue.get(monster_name)
    ...
    while True:
        ...
        if not easygui.ynbox("Do you want to continue editing this monster "
                             "card?", "Continue Editing?", ["Yes", "No"]):
            break
