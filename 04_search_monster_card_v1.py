...
Asks the user of the name of the existing monster
card to search using an easygui enterbox
"""
...
# Trial 1 = Using an Easygui Enterbox
def search_monster_card(catalogue):
    while True:
        ...
        if not found:
            if easygui.ynbox("Monster card not found. Would you like to "
                             "search again?", "Not Found", ["Yes", "No"]):
                continue
            else:
                break
